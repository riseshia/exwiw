-- Auto-generated by exwiw. Idempotent CREATE statements for sqlite3.
...
CREATE INDEX IF NOT EXISTS "index_products_on_shop_id" ON "products" ("shop_id");
...
CREATE INDEX IF NOT EXISTS "index_users_on_shop_id" ON "users" ("shop_id");
...
CREATE INDEX IF NOT EXISTS "index_transactions_on_order_id" ON "transactions" ("order_id");
