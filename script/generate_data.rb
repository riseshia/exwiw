...
raise "Usage: ruby generate_data.rb <adapter>" unless adapter
...
5.times do |i|
  ...
  users.each do |user|
    products.each do |product|
      ...
      # Uncomment when polimorphic association is implemented
...
3.times do |i|
  SystemAnnouncement.create(title: "Announcement #{i + 1}", content: "This is the content of announcement #{i + 1}.", created_at: time, updated_at: time)
end
